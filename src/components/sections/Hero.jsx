  ...
  return (
    <BackgroundGradientAnimation>
      <div className="absolute z-50 inset-0 flex flex-col gap-10 items-center justify-center px-4 pointer-events-none text-center">
        ...
        {/* Desctiption text */}
        <p className="text-2xl font-light tracking-tight max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl mx-auto">
          Editr is a simple, free and easy to use online editor, with all the necessary features, clean UI, and more. Make quick notes, share and collaborate easily, and much more!
        </p>
      </div>
    </BackgroundGradientAnimation>
  )
